...
export function LogoLight({ height = 36, color = "#0A0A0A" }: LogoProps) {
...
export function LogoDark({ height = 36, color = "#FFFFFF" }: LogoProps) {
  const w = height * (260 / 80)
  return (
    <svg width={w} height={height} viewBox="0 0 260 80" xmlns="http://www.w3.org/2000/svg">
      <text x="10" y="55" fontFamily="'Manrope', sans-serif">
...
// Compact icon (bw>) — sidebar, mobile header
export function LogoIcon({ height = 36, color = "#FFFFFF" }: LogoProps) {
